...
export default function Homepage() {
  ...
  const sndlastestNewsImage =
    latestNews.length > 0 ? latestNews[1].image : null;
  const thlastestNewsImage = latestNews.length > 0 ? latestNews[2].image : null;
  const fhtlastestNewsImage =
    latestNews.length > 0 ? latestNews[3].image : null;
  const lastlatestNewsImage =
    latestNews.length > 0 ? latestNews[4].image : null;
